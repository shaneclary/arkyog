        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-end">
          <div>
            ...
            <p className="mt-7 max-w-xl text-xl text-[var(--color-stone)] leading-relaxed">
              Seventy-two years old, turning seventy-three this May. Forty-five
              years teaching. A practice that started with ballet and gymnastics
              in childhood, passed through Pune, Shaolin, and decades of direct
              study with Pattabhi Jois, and has been refined every day since.
            </p>
          </div>
      ...
      <section className="container-page py-24 md:py-32">
        <div className="prose-yoga mx-auto">
          <p>
            ...
            body was being trained by Soviet-era coaches in Riga — eight hours a
            day, six days a week, no excuses. By twelve I was on the national
            track. By sixteen I had blown out a knee and been told I would
            never compete again.
          </p>
          <p>
          ...
          <p>
            I went to find the real thing. Years of direct study with Pattabhi
            Jois. Long stretches in Pune with Iyengar. Time in India with
            Akilanka studying the kriyas and the pranayamas. And — because I
            refused to believe the Indians had the only word on internal arts
            — four years going back and forth to the Shaolin temple, where I
            studied the 18 Lohan Hands, the staff, the sword.
          </p>
          <p>
          ...
          <p>
            I live in Riga now — back where I started. I teach a live
            three-hour class every Sunday and maintain a library of more than
            twenty hours of recorded practice. A handful of times a year I
            travel to lead retreats — Corfu, Montenegro, southern Turkey, the
            Caucasus of Georgia, and Miami. My oldest active student is 84.
            My youngest is 6. Both of them practice the same Foundation Series
            — and that, in a sentence, is what this work is about.
          </p>
        </div>
      </section>
